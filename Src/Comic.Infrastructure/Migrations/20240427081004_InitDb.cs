        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetaKeyword = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Point = table.Column<decimal>(type: "decimal(13,1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    HotFlag = table.Column<bool>(type: "bit", nullable: false),
                    StoryId = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActived = table.Column<bool>(type: "bit", nullable: false),
                    Slug = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    StoryId = table.Column<string>(type: "nvarchar(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChapterId = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActived = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentLv1s", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentLv1s_Chapters_ChapterId",
                        column: x => x.ChapterId,
                        principalTable: "Chapters",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CommentLv1s_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CommentLv1Id = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActived = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentLv2s", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentLv2s_CommentLv1s_CommentLv1Id",
                        column: x => x.CommentLv1Id,
                        principalTable: "CommentLv1s",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CommentLv2s_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentLv1s_ChapterId",
                table: "CommentLv1s",
                column: "ChapterId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentLv1s_UserId",
                table: "CommentLv1s",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentLv2s_CommentLv1Id",
                table: "CommentLv2s",
                column: "CommentLv1Id");

            migrationBuilder.CreateIndex(
                name: "IX_CommentLv2s_UserId",
                table: "CommentLv2s",
                column: "UserId");
